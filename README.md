...
2) Give your personal account the IAM role `roles/iam.serviceAccountTokenCreator` role: 
`gcloud iam service-accounts add-iam-policy-binding <LOCAL DEV SERVICE ACCOUNT> --member=user:<YOUR ACCOUNT EMAIL> --role=roles/iam.serviceAccountTokenCreator `.
